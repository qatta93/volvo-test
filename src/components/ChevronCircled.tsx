...
export const ChevronCircledLeft = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" transform="scale (-1, 1)" transform-origin="center">
...
export const ChevronCircledRight = () => {
  return (
